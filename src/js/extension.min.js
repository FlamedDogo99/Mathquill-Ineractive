 ...
 * Touch handler
 */
let undoButton=document.getElementById("undo"),redoButton=document.getElementById("redo"),copyButton=document.getElementById("copy"),pasteButton=document.getElementById("paste");function undoText(e){return e.preventDefault(),undoManager.undo(),!1}function redoText(e){return e.preventDefault(),undoManager.redo(),!1}function copyText(e){return e.preventDefault(),mathField.__controller.cursor.selection&&((copyField=document.getElementById("copyField")).value=mathField.__controller.cursor.selection.join("latex"),copyField.select(),copyField.setSelectionRange(0,99999),document.execCommand("copy"),navigator.clipboard.writeText(copyField.value),mathField.focus()),!1}function pasteText(e){return e.preventDefault(),navigator.clipboard.readText().then(e=>{let t=new window.DataTransfer;t.setData("text/plain",e),document.activeElement.dispatchEvent(new ClipboardEvent("paste",{bubbles:!0,cancelable:!0,clipboardData:t}))}),!1}function TouchEventMapper(e){e.target;let t;switch(e.type){case"touchstart":t="mousedown";break;case"touchmove":t="mousemove";break;case"touchend":case"touchcancel":t="mouseup";break;default:return}let n=e.changedTouches[0],o=n.clientX,a=n.pageX,r=window.pageXOffset,c=n.clientY,u=n.pageY,d=window.pageYOffset;0===a&&Math.floor(o)>Math.floor(a)||0===u&&Math.floor(c)>Math.floor(u)?(o-=r,c-=d):(o<a-r||c<u-d)&&(o=a-r,c=u-d);let s=new MouseEvent(t,{bubbles:!0,cancelable:!0,screenX:n.screenX,screenY:n.screenY,clientX:n.clientX,clientY:n.clientY,pageX:n.pageX,pageY:n.pageU,buttons:1,button:0,ctrlKey:e.ctrlKey,shiftKey:e.shiftKey,altKey:e.altKey,metaKey:e.metaKey});this.dispatchEvent(s)}undoButton.addEventListener("mousedown",undoText,!1),undoButton.addEventListener("touchstart",undoText,!1),redoButton.addEventListener("mousedown",redoText,!1),redoButton.addEventListener("touchstart",redoText,!1),copyButton.addEventListener("mousedown",copyText,!1),copyButton.addEventListener("touchstart",copyText,!1),pasteButton.addEventListener("mousedown",pasteText,!1),pasteButton.addEventListener("touchstart",pasteText,!1),document.querySelector("#math-field").addEventListener("touchstart",TouchEventMapper,!0),document.addEventListener("touchmove",TouchEventMapper,!0),document.addEventListener("touchend",TouchEventMapper,!0),document.addEventListener("touchcancel",TouchEventMapper,!0);
