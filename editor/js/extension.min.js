 ...
 * Setup
 */
const L="left",R="right",MQ=MathQuill.getInterface(2);function setupMathField(){MQ.registerEmbed("linebreak",(function(){const e=document.createElement("span");return e.className="mq-line-break",{htmlString:e.outerHTML,text:function(){return"\\newline"},latex:function(){return"\\newline"}}})),mathFieldEl=$("#math-field");const e=MQ.MathField(document.getElementById("math-field"),{spaceBehavesLikeTab:!1,restrictMismatchedBrackets:!1,autoCommands:"alpha beta sqrt theta phi rho pi tau nthroot cbrt sum prod integral percent infinity infty cross ans frac int gamma Gamma delta Delta epsilon zeta eta Theta iota kappa lambda Lambda mu Xi xi Pi sigma Sigma upsilon Upsilon Phi chi psi Psi omega Omega",charsThatBreakOutOfSupSub:"",handlers:{edit:function(){let t=e.latex();t=t.replace(/\\embed{linebreak}/g,"\\newline"),document.getElementById("latex-output").value=t}}});return document.getElementById("math-field").addEventListener("keydown",(function(t){if("Enter"===t.key){t.preventDefault(),e.write("\\embed{linebreak}");let n=e.latex();n=n.replace(/\\embed{linebreak}/g,"\\newline"),document.getElementById("latex-output").value=n}else"ArrowUp"!==t.key&&"ArrowDown"!==t.key||(t.preventDefault(),moveCursorManually(e,"ArrowUp"===t.key?"up":"down"))})),document.getElementById("math-field").addEventListener("paste",mathPaste,!1),e}function mathPaste(e){e.preventDefault(),e.stopPropagation();let t=(e.clipboardData||window.clipboardData).getData("Text");t=t.replace(/\\newline/g,"\\embed{linebreak}"),mathField.__controller.cursor.deleteSelection(),mathField.write(t),mathField.__controller.textarea[0].value="";let n=mathField.latex();n=n.replace(/\\embed{linebreak}/g,"\\newline"),document.getElementById("latex-output").value=n}function sourceHandler(e){let t=this.value;t&&(t=t.replace(/\\newline/g,"\\embed{linebreak}"),mathField.latex(t))}function moveCursorManually(e,t){const n=e.__controller.cursor;let i=getCurrentLine(n),a="up"===t?i-1:i+1,r=getCursorPosInLine(n),l=getLineNode(n,i,a,t);l&&moveToClosestPosition(n,a,l,r,t)}function getCurrentLine(e){let t=0,n=e[MQ.L];for(;n;)n.jQ&&n.jQ.hasClass("mq-line-break")&&t++,n=n[MQ.L];return t}function getCursorPosInLine(e){let t=0,n=e[MQ.L];for(;n&&(!n.jQ||!n.jQ.hasClass("mq-line-break"));)t++,n=n[MQ.L];return t}function getLineNode(e,t,n,i){let a=t;if("up"==i){for(var r=e[MQ.L];r;){if(r.jQ&&r.jQ.hasClass("mq-line-break")&&(r=r[MQ.L],a--),n==a)return r[MQ.L];r=r[MQ.L]}return null}for(r=e[MQ.R];r;){if(r.jQ&&r.jQ.hasClass("mq-line-break")&&(r=r[MQ.R],a++),n==a)return r;r=r[MQ.R]}return null}function moveToClosestPosition(e,t,n,i,a){e.insRightOf(n);let r=getCursorPosInLine(e);if(i<r){let o=r-i,u=n;for(let e=0;e<o;e++){if(!(l=u[MQ.L]))break;if(l.jQ&&l.jQ.hasClass("mq-line-break")){u=l;break}u=l}if("up"==a&&0==t&&0==i)for(;e[MQ.L];)e.insLeftOf(e[MQ.L]);else e.insRightOf(u)}else if(i>r){let t=i-r,a=n;for(let e=0;e<t;e++){var l;if(!(l=a[MQ.R]))break;if(l.jQ&&l.jQ.hasClass("mq-line-break"))break;a=l}e.insRightOf(a)}e.show()}latexSource=document.getElementById("latex-output"),latexSource.addEventListener("input",sourceHandler,!1);const mathField=setupMathField();function observeElement(e,t,n,i=0){let a=Object.getPrototypeOf(e);if(a.hasOwnProperty(t)){let r=Object.getOwnPropertyDescriptor(a,t);Object.defineProperty(e,t,{get:function(){return r.get.apply(this,arguments)},set:function(){let e=this[t];r.set.apply(this,arguments);let a=this[t];return"function"==typeof n&&setTimeout(n.bind(this,e,a),i),a}})}}function translatefieldDifferences(e){var t=[],n=0;return e.forEach((e=>{const i=e[1].length,a=e[0];0!==a&&t.push({0:a,1:n,2:i,3:e[1]}),-1!==a&&(n+=i)})),t}function runChanges(e,t,n=!1){var i=e;return t.forEach((e=>{const t=e[1],a=e[2],r=e[0]*(n?-1:1)==-1,l=e[3];i=r?i.slice(0,t)+i.slice(t+a):i.slice(0,t)+l+i.slice(t)})),i}function reverseChanges(e,t){return runChanges(e,t.map(((e,n)=>t[t.length-1-n])),!0)}var inputHistory={0:0,1:"",2:[]},inputField=document.getElementById("latex-output");function inputChange(e){const t=inputHistory[1],n=this.value;if(t!==n){const e=translatefieldDifferences((new diff_match_patch).diff_main(t,n)),i=inputHistory[2].length,a=inputHistory[0];i>a&&(inputHistory[2]=inputHistory[2].slice(0,a-i)),inputHistory[2].push(e),inputHistory[0]+=1,inputHistory[1]=this.value}}function catchUndo(e){const t="z"===e.key&&(e.ctrlKey||e.metaKey),n=e.shiftKey;t&&(e.preventDefault(),inputField.this=inputHistory[1],n?redoInput():undoInput())}function undoInput(){const e=inputHistory[0];if(e>0){const t=inputHistory[2][e-1],n=reverseChanges(inputField.value,t);inputField.value=n,mathField.latex(n.replace(/\\newline/g,"\\embed{linebreak}")),inputHistory[1]=n,inputHistory[0]-=1}}function redoInput(){const e=inputHistory[0];if(e<inputHistory[2].length){const t=runChanges(inputField.value,inputHistory[2][e]);inputField.value=t,mathField.latex(t.replace(/\\newline/g,"\\embed{linebreak}")),inputHistory[1]=t,inputHistory[0]+=1}}inputField.addEventListener("input",inputChange,!1),observeElement(inputField,"value",inputChange),inputField.addEventListener("keydown",catchUndo,!1),document.getElementById("math-field").addEventListener("keydown",catchUndo,!1);