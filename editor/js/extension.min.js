...
var mathFieldElement=document.getElementById("math-field");let undoButton=document.getElementById("undo"),redoButton=document.getElementById("redo"),copyButton=document.getElementById("copy"),pasteButton=document.getElementById("paste"),urlButton=document.getElementById("updateUrl"),printButton=document.getElementById("print");function preventButton(e){return e.preventDefault(),!1}function TouchEventMapper(e){let t;e.target;switch(e.type){case"touchstart":t="mousedown";break;case"touchmove":t="mousemove";break;case"touchend":case"touchcancel":t="mouseup";break;default:return}let n=e.changedTouches[0],i=n.clientX,a=n.pageX,o=window.pageXOffset,r=n.clientY,l=n.pageY,u=window.pageYOffset;0===a&&Math.floor(i)>Math.floor(a)||0===l&&Math.floor(r)>Math.floor(l)?(i-=o,r-=u):(i<a-o||r<l-u)&&(i=a-o,r=l-u);let s=new MouseEvent(t,{bubbles:!0,cancelable:!0,screenX:n.screenX,screenY:n.screenY,clientX:n.clientX,clientY:n.clientY,pageX:n.pageX,pageY:n.pageU,buttons:1,button:0,ctrlKey:e.ctrlKey,shiftKey:e.shiftKey,altKey:e.altKey,metaKey:e.metaKey});this.dispatchEvent(s)}undoButton.addEventListener("pointerdown",preventButton,!1),redoButton.addEventListener("pointerdown",preventButton,!1),copyButton.addEventListener("pointerdown",preventButton,!1),pasteButton.addEventListener("pointerdown",preventButton,!1),urlButton.addEventListener("pointerdown",preventButton,!1),printButton.addEventListener("pointerdown",preventButton,!1),undoButton.addEventListener("click",(e=>(undoInput(),!1)),!1),redoButton.addEventListener("click",(e=>(redoInput(),!1)),!1),copyButton.addEventListener("click",(e=>{if(mathField.__controller.cursor.selection){const e=mathField.__controller.cursor.selection.join("latex");navigator.clipboard.writeText(`${e}`),mathField.focus()}}),!1),pasteButton.addEventListener("click",(async e=>(navigator.clipboard.readText().then((e=>{const t=new window.DataTransfer;t.setData("text/plain",e),document.activeElement.dispatchEvent(new ClipboardEvent("paste",{bubbles:!0,cancelable:!0,clipboardData:t}))})),!1)),!1),urlButton.addEventListener("click",(e=>{const t=new URL(window.location.href);t.searchParams.set("latex",latexSource.value),window.history.replaceState({},"",t.toString())})),printButton.addEventListener("click",(e=>{window.print()})),mathFieldElement.addEventListener("touchstart",TouchEventMapper,!0),document.addEventListener("touchmove",TouchEventMapper,!0),document.addEventListener("touchend",TouchEventMapper,!0),document.addEventListener("touchcancel",TouchEventMapper,!0);const L="left",R="right",MQ=MathQuill.getInterface(2);function setupMathField(){MQ.registerEmbed("linebreak",(function(){const e=document.createElement("span");return e.className="mq-line-break",{htmlString:e.outerHTML,text:function(){return"\\newline"},latex:function(){return"\\newline"}}}));const e=MQ.MathField(mathFieldElement,{spaceBehavesLikeTab:!1,restrictMismatchedBrackets:!1,autoCommands:"alpha beta sqrt theta phi rho pi tau nthroot cbrt sum prod integral percent infinity infty cross ans frac int gamma Gamma delta Delta epsilon zeta eta Theta iota kappa lambda Lambda mu Xi xi Pi sigma Sigma upsilon Upsilon Phi chi psi Psi omega Omega",charsThatBreakOutOfSupSub:"",handlers:{edit:function(){let t=e.latex();t=t.replace(/\\embed{linebreak}/g,"\\newline"),document.getElementById("latex-output").value=t}}});mathFieldElement.addEventListener("keydown",(function(t){if("Enter"===t.key){t.preventDefault(),e.write("\\embed{linebreak}");let n=e.latex();n=n.replace(/\\embed{linebreak}/g,"\\newline"),document.getElementById("latex-output").value=n}else"ArrowUp"!==t.key&&"ArrowDown"!==t.key||(t.preventDefault(),moveCursorManually(e,"ArrowUp"===t.key?"up":"down"))})),mathFieldElement.addEventListener("paste",mathPaste,!1);let t=new URL(document.location.toString()).searchParams.get("latex");if(t){var n=decodeURIComponent(t);n=n.replace(/\\newline/g,"\\embed{linebreak}"),e.latex(n),document.getElementById("latex-output").value=n}return e}function mathPaste(e){e.preventDefault(),e.stopPropagation();let t=(e.clipboardData||window.clipboardData).getData("Text");t=t.replace(/\\newline/g,"\\embed{linebreak}"),mathField.__controller.cursor.deleteSelection(),mathField.write(t),mathField.__controller.textarea[0].value="";let n=mathField.latex();n=n.replace(/\\embed{linebreak}/g,"\\newline"),document.getElementById("latex-output").value=n}function sourceHandler(e){let t=this.value;t&&(t=t.replace(/\\newline/g,"\\embed{linebreak}"),mathField.latex(t))}function moveCursorManually(e,t){const n=e.__controller.cursor;let i=getCurrentLine(n),a="up"===t?i-1:i+1,o=getCursorPosInLine(n),r=getLineNode(n,i,a,t);r&&moveToClosestPosition(n,a,r,o,t)}function getCurrentLine(e){let t=0,n=e[MQ.L];for(;n;)n.jQ&&n.jQ.hasClass("mq-line-break")&&t++,n=n[MQ.L];return t}function getCursorPosInLine(e){let t=0,n=e[MQ.L];for(;n&&(!n.jQ||!n.jQ.hasClass("mq-line-break"));)t++,n=n[MQ.L];return t}function getLineNode(e,t,n,i){let a=t;if("up"==i){for(var o=e[MQ.L];o;){if(o.jQ&&o.jQ.hasClass("mq-line-break")&&(o=o[MQ.L],a--),n==a)return o[MQ.L];o=o[MQ.L]}return null}for(o=e[MQ.R];o;){if(o.jQ&&o.jQ.hasClass("mq-line-break")&&(o=o[MQ.R],a++),n==a)return o;o=o[MQ.R]}return null}function moveToClosestPosition(e,t,n,i,a){e.insRightOf(n);let o=getCursorPosInLine(e);if(i<o){let l=o-i,u=n;for(let e=0;e<l;e++){if(!(r=u[MQ.L]))break;if(r.jQ&&r.jQ.hasClass("mq-line-break")){u=r;break}u=r}if("up"==a&&0==t&&0==i)for(;e[MQ.L];)e.insLeftOf(e[MQ.L]);else e.insRightOf(u)}else if(i>o){let t=i-o,a=n;for(let e=0;e<t;e++){var r;if(!(r=a[MQ.R]))break;if(r.jQ&&r.jQ.hasClass("mq-line-break"))break;a=r}e.insRightOf(a)}e.show()}latexSource=document.getElementById("latex-output"),latexSource.addEventListener("input",sourceHandler,!1);const mathField=setupMathField();function observeElement(e,t,n,i=0){let a=Object.getPrototypeOf(e);if(a.hasOwnProperty(t)){let o=Object.getOwnPropertyDescriptor(a,t);Object.defineProperty(e,t,{get:function(){return o.get.apply(this,arguments)},set:function(){let e=this[t];o.set.apply(this,arguments);let a=this[t];return"function"==typeof n&&setTimeout(n.bind(this,e,a),i),a}})}}function translatefieldDifferences(e){var t=[],n=0;return e.forEach((e=>{const i=e[1].length,a=e[0];0!==a&&t.push({0:a,1:n,2:i,3:e[1]}),-1!==a&&(n+=i)})),t}function runChanges(e,t,n=!1){var i=e;return t.forEach((e=>{const t=e[1],a=e[2],o=e[0]*(n?-1:1)==-1,r=e[3];i=o?i.slice(0,t)+i.slice(t+a):i.slice(0,t)+r+i.slice(t)})),i}function reverseChanges(e,t){return runChanges(e,t.map(((e,n)=>t[t.length-1-n])),!0)}var inputHistory={0:0,1:"",2:[]},inputField=document.getElementById("latex-output");function inputChange(e){const t=inputHistory[1],n=this.value;if(t!==n){const e=translatefieldDifferences((new diff_match_patch).diff_main(t,n)),i=inputHistory[2].length,a=inputHistory[0];i>a&&(inputHistory[2]=inputHistory[2].slice(0,a-i)),inputHistory[2].push(e),inputHistory[0]+=1,inputHistory[1]=this.value}}function catchUndo(e){const t="z"===e.key&&(e.ctrlKey||e.metaKey),n=e.shiftKey;t&&(e.preventDefault(),inputField.this=inputHistory[1],n?redoInput():undoInput())}function catchSoftwareUndo(e){const t=inputHistory[0],n=inputHistory[2].length;"historyUndo"==e.inputType&&(t<n&&e.preventDefault(),undoInput()),"historyRedo"==e.inputType&&t!==n&&e.preventDefault(),redoInput()}function undoInput(){const e=inputHistory[0];if(e>0){const t=inputHistory[2][e-1],n=reverseChanges(inputField.value,t);inputField.value=n,mathField.latex(n.replace(/\\newline/g,"\\embed{linebreak}")),inputHistory[1]=n,inputHistory[0]-=1}}function redoInput(){const e=inputHistory[0];if(e<inputHistory[2].length){const t=runChanges(inputField.value,inputHistory[2][e]);inputField.value=t,mathField.latex(t.replace(/\\newline/g,"\\embed{linebreak}")),inputHistory[1]=t,inputHistory[0]+=1}}inputField.addEventListener("input",inputChange,!1),observeElement(inputField,"value",inputChange),inputField.addEventListener("keydown",catchUndo,!1),mathFieldElement.addEventListener("keydown",catchUndo,!1),inputField.addEventListener("beforeinput",catchSoftwareUndo,!1),mathFieldElement.getElementsByTagName("textarea")[0].addEventListener("beforeinput",catchSoftwareUndo,!1);